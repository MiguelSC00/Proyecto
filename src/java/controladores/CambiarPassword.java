...
public class CambiarPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String passwordAcutal = request.getParameter("passwordActual");
        String passwordNueva1 = request.getParameter("passwordNueva1");
        String passwordNueva2 = request.getParameter("passwordNueva2");
        
        if (passwordAcutal != "" && passwordNueva1 != "" && passwordNueva2 != "") {
            if (u.getPassword().equals(passwordAcutal)) {
            
                if (passwordNueva1.equals(passwordNueva2)) {

                    try {
                        DaoUsuario.cambiarPassword(passwordNueva1, u.getUsuario());
                        u.setPassword(passwordNueva1);
