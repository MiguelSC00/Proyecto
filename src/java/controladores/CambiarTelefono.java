 ...
 * @author Miguel
 */
@WebServlet(name = "CambiarTelefono", urlPatterns = {"/CambiarTelefono"})
public class CambiarTelefono extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (telefono != "") {
            ...
            if (telefono.length() == 9 && telefono.matches("[+-]?\\d*(\\.\\d+)?")) {
                ...
                try {
                    DaoUsuario.cambiarTelefono(telefono, u.getUsuario());
                ...
                request.setAttribute("errorTelefono", error);
